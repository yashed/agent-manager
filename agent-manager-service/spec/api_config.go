...
func (r ApiGetConfigRequest) Execute() (*ConfigResponse, *http.Response, error) {
...
Returns service URLs that CLI clients need for direct backend access.
...
func (a *ConfigAPIService) GetConfigExecute(r ApiGetConfigRequest) (*ConfigResponse, *http.Response, error) {
	var (
