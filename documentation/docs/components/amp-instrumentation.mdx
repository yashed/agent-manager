...
Operators: see [Instrumentation Catalog](../administration/instrumentation-catalog.mdx) for how to add a version, mirror images for air-gapped installs, and set the platform default.